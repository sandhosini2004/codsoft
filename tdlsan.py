...
def complete_task():
    ...
    if selected_task_index:
        ...
        completed_task = selected_task + " (Done)"
        task_listbox.delete(selected_task_index)
        task_listbox.insert(selected_task_index, completed_task)
        messagebox.showinfo("Task Completed", "Task Done!")
...
complete_button = tk.Button(task_frame, text="Complete Task", font=("Helvetica", 16), bg="black", fg="white", command=complete_task)
